...
class SermonViewController: UITableViewController {
    ...
    var sermon = SermonModel()
    
    var thisSermon = [SermonModelData!]()
    
    var sermonModel: SermonModelData! {
        didSet{
            self.thisSermon = [sermonModel]
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let sermons = sermon.fetchedSermon[indexPath.row] as SermonModelData
